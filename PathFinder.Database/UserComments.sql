...
(
	...
	CONSTRAINT [FkUserComments_AuthorId] FOREIGN KEY([AuthorId]) REFERENCES [dbo].[AspNetUsers](Id),
	CONSTRAINT [FkUserComments_TargetId] FOREIGN KEY([TargetId]) REFERENCES [dbo].[AspNetUsers](Id), 
